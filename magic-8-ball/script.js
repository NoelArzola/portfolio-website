...
eightBall.getFortune = function(question) {
    ...
    var randomNum = Math.ceil(Math.round(Math.random() * eightBall.listOfAnswers.length));
    
    var fortune = eightBall.listOfAnswers[randomNum];
    ...
    setTimeout(
        ...
        function() {
            ...
            var questionPrompt = prompt("ASK A YES OR NO QUESTION!", "Does Skillcrush Rock?");
